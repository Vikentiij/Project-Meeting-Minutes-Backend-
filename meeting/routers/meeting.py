...
from meeting.oauth2 import get_current_user
...
def update(id:int, request: schemas.Meeting, db: Session = Depends(get_db), current_user: schemas.User = Depends(oauth2.get_current_user)):
